...
class TankTankService {
  ...
  Future<List<TrTankManagementsTankRow>> search(
    ...
    try {
      String token = await storageApp.getAccessToken();
      final url = Uri.https(
          URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank/search");
      final headers = {
      ...
      if (appService.checkExpired(response.statusCode)) {
        ...
        ResTankTankSearchModel data =
            ResTankTankSearchModel.fromJson(jsonDecode(response.body));
        if (data.code == 200) {
          if (data.result == 'success') {
  ...
  Future<ResCheckStatusModel> updatestatus9(
    ...
    try {
      ...
      final url = Uri.https(URL_API_APP,
          "$VERSION_API_APP/trtankmanagementmbtank/acceptwork/$id");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
  ...
  Future<List<JobMovingModel>> getAll(BuildContext context) async {
    ...
    try {
      String token = await storageApp.getAccessToken();
      final url =
          Uri.https(URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
  ...
  Future<TankTankDetailsData> getById(BuildContext context, String id) async {
    StorageApp storageApp = StorageApp();
    AppService appService = AppService();
    try {
      String token = await storageApp.getAccessToken();
      final url =
          Uri.https(URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank/$id");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
      ...
      if (appService.checkExpired(response.statusCode)) {
        ...
        ResTankTankDetailsModel data =
            ResTankTankDetailsModel.fromJson(jsonDecode(response.body));
        if (data.code == 200) {
          if (data.result == 'success') {
            return data.data;
          } else {
  ...
  Future<MasterDataTankModel> getMasterData(BuildContext context) async {
    ...
    try {
      String token = await storageApp.getAccessToken();
      final url = Uri.https(
          URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank/getdatamaster");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
  ...
  Future<ResCheckStatusModel> cancelWork(
      BuildContext context, String id) async {
    StorageApp storageApp = StorageApp();
    AppService appService = AppService();
    try {
      String token = await storageApp.getAccessToken();
      final url = Uri.https(URL_API_APP,
          "$VERSION_API_APP/trtankmanagementmbtank/cancelwork/$id");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
  ...
  Future<ResAttachmentNoDataModel> attatchment(
    ...
    try {
      String token = await storageApp.getAccessToken();
      final url = Uri.https(
          URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank/attatchment/");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
  ...
  Future<ResAttachmentModel> download(BuildContext context, String id) async {
    ...
    try {
      String token = await storageApp.getAccessToken();
      final url = Uri.https(
          URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank/download/$id");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
  ...
  Future<ResponseModel> deleteAttachment(
    ...
    try {
      String token = await storageApp.getAccessToken();
      final url = Uri.https(
          URL_API_APP, "$VERSION_API_APP/trtankmanagementmbtank/delbyfile/$id");
      final headers = {
        "Content-Type": "application/json",
        "Authorization": "Bearer $token",
      };
