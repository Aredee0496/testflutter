      ...
      RichText(
        text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                text: increaseAllowance, style: TextStyle(color: Colors.grey))
          ],
        ),
      ),
      RichText(
        text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                text: deductAllowance, style: TextStyle(color: Colors.grey))
          ],
        ),
      ),
      Table(
      ...
      RichText(
        text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(
                text: increaseFuelCost, style: TextStyle(color: Colors.grey))
          ],
        ),
      ),
      RichText(
        text: TextSpan(
          ...
          children: <TextSpan>[
            ...
            TextSpan(text: deductFuelCost, style: TextStyle(color: Colors.grey))
          ],
        ),
      ),
      Table(
