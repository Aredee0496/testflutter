...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    controller = WebViewController()
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          ...
          onNavigationRequest: (NavigationRequest request) async {
            ...
            print("onNavigationRequest pageReDirect: ${widget.pageReDirect}");
            print("onNavigationRequest: ${request.url}");
            String pageReDirect = "${widget.pageReDirect}?";
            if (pageReDirect.startsWith(request.url)) {
              print("onNavigationRequest: ${request.url}");
      ...
      ..loadRequest(Uri.parse('${widget.url}?localid=${widget.token}'));
